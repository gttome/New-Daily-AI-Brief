...
Operational activation must remain blocked until the Iteration 13 closure-package PR and post-merge \`main\` verification are complete and reconciled into the repository evidence.
