...
from .contracts import (
    ...
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_REVIEW_POLICY_VERSION,
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_REVIEW_SCHEMA_VERSION,
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_REVIEW_EVIDENCE_VERSION,
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_POLICY_VERSION,
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_EVIDENCE_VERSION,
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_RECORD_VERSION,
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_SCHEMA_VERSION,
)
from .integration_execution_executor_binding_authorization_review import (
    ProductionIntegrationExecutionExecutorBindingAuthorizationReview,
    IntegrationExecutionExecutorBindingAuthorizationReviewError,
)
from .store import CanonicalStore, ContractError, digest, semantic_digest


class IntegrationExecutionExecutorBindingAuthorizationDecisionError(ContractError):
    pass


class IntegrationExecutionExecutorBindingAuthorizationDecisionBoundaryFailure(
    IntegrationExecutionExecutorBindingAuthorizationDecisionError
):
...
class ProductionIntegrationExecutionExecutorBindingAuthorizationDecision:
    """Deterministic synthetic-only Iteration 24 executor-binding authorization decision gate."""

    ARTIFACT_TYPE = "production-integration-execution-executor-binding-authorization-decision"
    SOURCE_ARTIFACT_TYPE = "production-integration-execution-executor-binding-authorization-review"
    ...
    SOURCE_OUTPUT_FIELDS = {
        "executor_binding_authorization_review_id",
    ...
    POLICY_KEYS = {
        "schema_version",
        "executor_binding_authorization_decision_policy_version",
        "policy_id",
        "synthetic_only",
    ...
    MANIFEST_KEYS = {
        "schema_version",
        "executor_binding_authorization_decision_manifest_version",
        "manifest_id",
        "synthetic_only",
        "production_action_authorized",
        "production_cutover_authorized",
        ...
        "rollback_execution_authorized",
        "real_integration_steps_enabled",
        "executor_binding_authorization_review_binding",
        "evidence",
        *MUTATION_FLAGS,
    }
    EVIDENCE_KEYS = {
    ...
    RECORD_KEYS = {
        ...
        "noop",
        "non_live",
        "executor_binding_authorization_review_evidence_ids",
        "executor_binding_authorization_review_evidence_digests",
        "scope",
        "synthetic_only",
        "executor_binding_authorization_review_artifact_digest",
        "executor_binding_authorization_review_id",
        "executor_binding_authorization_review_policy_id",
        "executor_binding_authorization_review_policy_digest",
        "executor_binding_authorization_review_manifest_id",
        "executor_binding_authorization_review_manifest_digest",
        "separate_executor_binding_authorization_review_id",
        "separate_executor_binding_authorization_review_digest",
        "synthetic_binding_plan_descriptor_id",
        "synthetic_binding_plan_descriptor_digest",
        "executor_binding_authorization_review_evidence_set_digest",
    ...
    def __init__(
        ...
        *,
        ...
        failure_class: str = "synthetic_integration_execution_executor_binding_authorization_decision_boundary_failure",
    ):
        self.store = store
        ...
        self.failure_boundary_id = (
            failure_boundary_id.removeprefix("executor_binding_authorization_decision:")
            if failure_boundary_id
            else None
        )
        self.failure_class = failure_class
        self._failure_fired = False
        self.state_path = self.store.run_dir / "executor-binding-authorization-decision-state.json"
        self.metrics_path = self.store.run_dir / "executor-binding-authorization-decision-metrics.json"
        self.incident_path = self.store.run_dir / "executor-binding-authorization-decision-incident.json"
    ...
    def _read_json_fixture(self, name: str, *, optional: bool = False) -> dict[str, Any] | None:
        if self.mode == "production" or self.fixture_root is None:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
        ...
        if not path.exists():
            if optional:
                return None
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                f"executor-binding-authorization-decision fixture missing: {name}"
            )
    ...
    def _bound_upstream_identity(
        ...
        return {
            **deepcopy(semantic_identity),
            "executor_binding_authorization_review_artifact_digest": artifact["content_digest"],
            "executor_binding_authorization_review_id": data["executor_binding_authorization_review_id"],
            "executor_binding_authorization_review_classification": data["classification"],
            "executor_binding_authorization_review_reason_codes": deepcopy(
                data.get("classification_reason_codes") or []
            ),
            "executor_binding_authorization_review_policy_id": data.get(
                "executor_binding_authorization_review_policy_id"
            ),
            "executor_binding_authorization_review_policy_digest": data.get(
                "executor_binding_authorization_review_policy_digest"
            ),
            "executor_binding_authorization_review_manifest_id": data.get(
                "executor_binding_authorization_review_manifest_id"
            ),
            "executor_binding_authorization_review_manifest_digest": data.get(
                "executor_binding_authorization_review_manifest_digest"
            ),
            "separate_executor_binding_authorization_review_id": data.get(
                "separate_executor_binding_authorization_review_id"
            ),
            "separate_executor_binding_authorization_review_digest": data.get(
                "separate_executor_binding_authorization_review_digest"
            ),
            ...
            "executor_binding_authorization_review_evidence_ids": deepcopy(
                data.get("executor_binding_authorization_review_evidence_ids") or []
            ),
            "executor_binding_authorization_review_evidence_digests": deepcopy(
                data.get("executor_binding_authorization_review_evidence_digests") or []
            ),
            "executor_binding_authorization_review_evidence_set_digest": digest(validations),
            "canonical_chain_digest": data.get("canonical_chain_digest"),
            "iteration23_semantic_identity": semantic_identity,
            "iteration23_semantic_identity_digest": digest(semantic_identity),
        }

    def _context(self, run: dict[str, Any]) -> dict[str, Any]:
        if self.mode not in {"synthetic", "shadow"}:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError("synthetic/shadow only")
        prior = ProductionIntegrationExecutionExecutorBindingAuthorizationReview(
        ...
        try:
            ...
            if (not evaluation or digest(evaluation) != state.get("evaluation_digest")
                ...
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                    "Iteration 23 durable review identity is stale or corrupted")
            if (data.get("executor_binding_authorization_review_schema_version") != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_REVIEW_SCHEMA_VERSION
                    or data.get("executor_binding_authorization_review_policy_version") != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_REVIEW_POLICY_VERSION
                    or data.get("executor_binding_authorization_review_policy_id") != "production-integration-execution-executor-binding-authorization-review-v1"
                    or data.get("executor_binding_authorization_review_manifest_id") != "production-integration-execution-executor-binding-authorization-review-manifest-v1"):
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError("unsupported Iteration 23 identity/version")
            validations = []
            for position, source in enumerate(prior_context["source_executor_binding_rehearsal_receipts"], 1):
                if evaluation["classification"] != "executor_binding_authorization_review_complete":
                    break
                ...
                if record != prior._receipt_record(prior_context, evaluation, position, source):
                    raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                        f"Iteration 23 evidence changed/missing at position {position}")
                validations.append(record)
            expected = prior._artifact_data({**deepcopy(evaluation),
                "executor_binding_authorization_review_evidence_records": validations})
            if data != expected:
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError("Iteration 23 locked review differs from exact durable evidence")
            prior.finalize(artifact)
        except IntegrationExecutionExecutorBindingAuthorizationReviewError as exc:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(str(exc)) from exc
        bound = self._bound_upstream_identity(artifact, data, validations)
        return {
            "executor_binding_authorization_review_artifact": artifact,
            "executor_binding_authorization_review_data": data,
            "source_executor_binding_authorization_review_evidence": validations,
    ...
    def _validate_policy_manifest(
        ...
        if set(policy) != self.POLICY_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "Iteration 24 policy contains unsupported fields"
            )
        if set(manifest) != self.MANIFEST_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "Iteration 24 manifest contains unsupported fields"
            )
        if (
            policy.get("schema_version")
            != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_SCHEMA_VERSION
            or policy.get("executor_binding_authorization_decision_policy_version")
            != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_POLICY_VERSION
            or policy.get("policy_id")
            != "production-integration-execution-executor-binding-authorization-decision-v1"
            or policy.get("synthetic_only") is not True
            or policy.get("allowed_upstream_classification")
            != "executor_binding_authorization_review_complete"
            or policy.get("classifications")
            != ["blocked", "executor_binding_authorization_decision_complete", "invalid"]
            ...
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "unsupported or unsafe Iteration 24 executor-binding-authorization-decision policy"
            )
        if (
            manifest.get("schema_version")
            != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_SCHEMA_VERSION
            or manifest.get("executor_binding_authorization_decision_manifest_version") != "1.0.0"
            or manifest.get("manifest_id")
            != "production-integration-execution-executor-binding-authorization-decision-manifest-v1"
            or manifest.get("synthetic_only") is not True
        ):
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "unsupported Iteration 24 executor-binding-authorization-decision manifest"
            )
        self._assert_no_authority(manifest, "Iteration 24 manifest")
        binding = manifest.get("executor_binding_authorization_review_binding")
        if not isinstance(binding, dict):
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError("invalid review binding")
        if binding and set(binding) != {
            "binding_mode", "executor_binding_authorization_review_artifact_digest",
            "executor_binding_authorization_review_id", "executor_binding_authorization_review_policy_id",
            "executor_binding_authorization_review_policy_digest", "executor_binding_authorization_review_manifest_id",
            "executor_binding_authorization_review_manifest_digest", "separate_executor_binding_authorization_review_id",
            "separate_executor_binding_authorization_review_digest", "synthetic_binding_plan_descriptor_id",
            "synthetic_binding_plan_descriptor_digest", "executor_binding_authorization_review_evidence_ids",
            "executor_binding_authorization_review_evidence_digests", "executor_binding_authorization_review_evidence_set_digest",
            "canonical_chain_digest", "iteration23_semantic_identity_digest", "bound_upstream_identity_digest"
        }:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError("unsupported review binding fields")
        evidence = manifest.get("evidence") or {}
        if set(evidence) != self.EVIDENCE_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "Iteration 24 manifest evidence contains unsupported fields"
            )
        ...
        if set(evidence.get("stop_abort_conditions") or []) != required:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "executor-binding-authorization-decision stop/abort conditions incomplete"
            )
    ...
    def _record_binding(
        ...
        if record is None:
            ...
            }, "EXECUTOR_BINDING_AUTHORIZATION_DECISION_RECORD_MISSING"
        if set(record) != self.RECORD_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "executor-binding-authorization-decision record contains unsupported fields"
            )
        body = deepcopy(record)
        supplied = body.pop("authorization_decision_record_id")
        if supplied != digest(body):
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "executor-binding-authorization-decision record semantic identity changed"
            )
        bound = context["bound_upstream_identity"]
        expected = {
            "schema_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_SCHEMA_VERSION,
            "record_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_RECORD_VERSION,
            "record_kind": "production-integration-execution-executor-binding-authorization-decision-record",
            "decision": "complete_synthetic_executor_binding_authorization_decision",
            "approved": True,
            "noop": True,
            "non_live": True,
            "executor_binding_authorization_review_evidence_ids": bound["executor_binding_authorization_review_evidence_ids"],
            "executor_binding_authorization_review_evidence_digests": bound["executor_binding_authorization_review_evidence_digests"],
            "scope": "execution_executor_binding_authorization_decision_only",
            "synthetic_only": True,
            "executor_binding_authorization_review_artifact_digest": bound[
                "executor_binding_authorization_review_artifact_digest"
            ],
            "executor_binding_authorization_review_id": bound["executor_binding_authorization_review_id"],
            "executor_binding_authorization_review_policy_id": bound[
                "executor_binding_authorization_review_policy_id"
            ],
            "executor_binding_authorization_review_policy_digest": bound[
                "executor_binding_authorization_review_policy_digest"
            ],
            "executor_binding_authorization_review_manifest_id": bound[
                "executor_binding_authorization_review_manifest_id"
            ],
            "executor_binding_authorization_review_manifest_digest": bound[
                "executor_binding_authorization_review_manifest_digest"
            ],
            "separate_executor_binding_authorization_review_id": bound[
                "separate_executor_binding_authorization_review_id"
            ],
            "separate_executor_binding_authorization_review_digest": bound[
                "separate_executor_binding_authorization_review_digest"
            ],
            ...
            "executor_binding_authorization_review_evidence_set_digest": bound[
                "executor_binding_authorization_review_evidence_set_digest"
            ],
            "canonical_chain_digest": bound["canonical_chain_digest"],
            "bound_upstream_identity_digest": context["bound_upstream_identity_digest"],
            "executor_binding_authorization_decision_manifest_id": manifest["manifest_id"],
        ...
        for key, value in expected.items():
            if digest(record.get(key)) != digest(value):
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                    f"executor-binding-authorization-decision record binding changed: {key}"
                )
        return {
    ...
    def _policy_manifest_record(
        ...
        policy = self._read_json_fixture("executor-binding-authorization-decision-policy.json")
        manifest = self._read_json_fixture("executor-binding-authorization-decision-manifest.json")
        record = self._read_json_fixture(
            "executor-binding-authorization-decision-record.json", optional=True
        )
    ...
    def _evaluate(
        ...
        source = context["bound_upstream_identity"][
            "executor_binding_authorization_review_classification"
        ]
        reasons = context["bound_upstream_identity"][
            "executor_binding_authorization_review_reason_codes"
        ]
        bound = context["bound_upstream_identity"]
        expected_source_binding = {
            "binding_mode": "exact_locked_executor_binding_authorization_review_artifact",
            "executor_binding_authorization_review_artifact_digest": bound[
                "executor_binding_authorization_review_artifact_digest"
            ],
            "executor_binding_authorization_review_id": bound["executor_binding_authorization_review_id"],
            ...
            "executor_binding_authorization_review_evidence_ids": bound[
                "executor_binding_authorization_review_evidence_ids"
            ],
            "executor_binding_authorization_review_evidence_digests": bound[
                "executor_binding_authorization_review_evidence_digests"
            ],
            "executor_binding_authorization_review_evidence_set_digest": bound[
                "executor_binding_authorization_review_evidence_set_digest"
            ...
            "canonical_chain_digest": bound["canonical_chain_digest"],
            "iteration23_semantic_identity_digest": bound[
                "iteration23_semantic_identity_digest"
            ],
            "bound_upstream_identity_digest": context["bound_upstream_identity_digest"],
        }
        binding = manifest.get("executor_binding_authorization_review_binding")
        if binding != expected_source_binding and not (binding == {} and source in {"blocked", "invalid"}):
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "executor-binding-authorization-decision manifest binds a different Iteration 23 identity"
            )
        if source == "invalid":
            return {
                "classification": "invalid",
                "classification_reason_codes": [
                    "ITERATION23_EXECUTOR_BINDING_AUTHORIZATION_REVIEW_INVALID",
                    *reasons,
                ],
                "decision_binding": {
                    "authorization_decision_record_id": None,
        ...
        if source == "blocked":
            return {
                ...
                "classification_reason_codes": [
                    "ITERATION23_EXECUTOR_BINDING_AUTHORIZATION_REVIEW_BLOCKED",
                    *reasons,
                ],
                "decision_binding": {
                    "authorization_decision_record_id": None,
        ...
        return {
            "classification": "executor_binding_authorization_decision_complete",
            "classification_reason_codes": [
                "SYNTHETIC_EXECUTOR_BINDING_AUTHORIZATION_DECISION_COMPLETE"
            ],
            "decision_binding": decision_binding,
        }
    ...
    def _input_identity(
        ...
        return {
            ...
            "executor_binding_authorization_review_id": bound["executor_binding_authorization_review_id"],
            "bound_upstream_identity_digest": context["bound_upstream_identity_digest"],
            "executor_binding_authorization_decision_policy_digest": digest(policy),
            "executor_binding_authorization_decision_manifest_digest": digest(manifest),
    ...
    def _load_state(self, identity: dict[str, Any]) -> dict[str, Any]:
        ...
        if (
            ...
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "executor-binding-authorization-decision durable state binds different inputs"
            )
        return state
    ...
    def _recover_incident_if_needed(self, state: dict[str, Any]) -> None:
        ...
        if incident and incident.get("result") == "pending":
            if incident.get("input_identity") != state.get("input_identity"):
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                    "executor-binding-authorization-decision incident binds different inputs"
                )
            incident["result"] = "recovered"
            self.store._atomic_write(self.incident_path, incident)

    def _receipt_path(self, position: int) -> Path:
        return self.store.run_dir / f"executor-binding-authorization-decision-evidence-{position:02d}.json"
    ...
    def _receipt_record(
        ...
        body = {
            "schema_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_SCHEMA_VERSION,
            "receipt_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_EVIDENCE_VERSION,
            "executor_binding_authorization_review_id": bound["executor_binding_authorization_review_id"],
            "executor_binding_authorization_review_artifact_digest": bound[
                "executor_binding_authorization_review_artifact_digest"
            ],
            "executor_binding_authorization_decision_record_id": evaluated[
                "decision_binding"
            ]["authorization_decision_record_id"],
            "synthetic_binding_plan_descriptor_id": bound[
                "synthetic_binding_plan_descriptor_id"
            ...
            "position": position,
            "source_executor_binding_authorization_review_evidence_id": source["receipt_id"],
            "source_executor_binding_authorization_review_evidence_digest": digest(source),
            "noop_verified": True,
    ...
    def _ensure_receipts(
        ...
        if evaluated["classification"] != "executor_binding_authorization_decision_complete":
            return []
        sources = context["source_executor_binding_authorization_review_evidence"]
        if len(sources) != 10:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
        ...
        for position, source in enumerate(sources, start=1):
            ...
            if existing is not None:
                if existing != expected:
                    raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                        f"cached executor-binding-authorization-decision evidence changed at position {position}"
                    )
            ...
            if self.failure_boundary_id == boundary and not self._failure_fired:
                ...
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionBoundaryFailure(
                    "executor_binding_authorization_decision_evidence",
                    boundary,
                    self.failure_class,
                )
    ...
    def prepare(self, run: dict[str, Any]) -> dict[str, Any]:
        ...
        if state.get("evaluation") is None:
            ...
            if self.failure_boundary_id == "evaluation" and not self._failure_fired:
                ...
                self._write_metrics(state)
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionBoundaryFailure(
                    "executor_binding_authorization_decision_evaluation",
                    "evaluation",
                    self.failure_class,
                )
            ...
            state["evaluation"] = {
                **outcome,
                ...
                "executor_binding_authorization_decision_policy_id": policy["policy_id"],
                "executor_binding_authorization_decision_policy_version": policy[
                    "executor_binding_authorization_decision_policy_version"
                ],
                "executor_binding_authorization_decision_manifest_id": manifest["manifest_id"],
            ...
            if digest(state["evaluation"]) != state.get("evaluation_digest"):
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError("cached decision evaluation corrupted")
        ...
        evaluated["executor_binding_authorization_decision_evidence_records"] = receipts
    ...
    def _artifact_data(self, evaluated: dict[str, Any]) -> dict[str, Any]:
        ...
        receipts = evaluated["executor_binding_authorization_decision_evidence_records"]
        evidence = evaluated["evidence"]
        if evaluated["classification"] == "executor_binding_authorization_decision_complete":
            if len(receipts) != 10:
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                    "executor_binding_authorization_decision_complete requires ten no-op receipts"
                )
            if len({x["receipt_id"] for x in receipts}) != 10:
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                    "executor-binding-authorization-decision evidence identities must be unique"
                )
        elif receipts:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
        ...
        identity = {
            "executor_binding_authorization_decision_schema_version": (
                EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_SCHEMA_VERSION
            ),
            "executor_binding_authorization_decision_policy_version": evaluated[
                "executor_binding_authorization_decision_policy_version"
            ],
            "executor_binding_authorization_decision_policy_id": evaluated[
                "executor_binding_authorization_decision_policy_id"
            ],
            "executor_binding_authorization_decision_policy_digest": evaluated[
                "input_identity"
            ]["executor_binding_authorization_decision_policy_digest"],
            "executor_binding_authorization_decision_manifest_id": evaluated[
                "executor_binding_authorization_decision_manifest_id"
            ],
            "executor_binding_authorization_decision_manifest_digest": evaluated[
                "input_identity"
            ]["executor_binding_authorization_decision_manifest_digest"],
            "separate_executor_binding_authorization_decision_id": decision_binding[
                "authorization_decision_record_id"
            ],
            "separate_executor_binding_authorization_decision_digest": decision_binding[
            ...
            **deepcopy(evaluated["bound_upstream_identity"]),
            ...
            "executor_binding_authorization_decision_evidence_set_digest": digest(receipts),
        ...
        return {
            **identity,
            "executor_binding_authorization_decision_id": digest(identity),
            "real_integration_steps_enabled": 0,
            "real_integration_steps_executed": 0,
            "final_state": "Complete",
            "final_status": "complete_locked",
            "completion_scope": (
                "synthetic_shadow_execution_executor_binding_authorization_decision_only"
            ),
            "synthetic_only": True,
            "production_action_authorized": False,
            "production_cutover_authorized": False,
    ...
    def validate_existing(
        ...
        if (
            ...
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionBoundaryFailure(
                "executor_binding_authorization_decision_validation",
                "executor_binding_authorization_decision_artifact",
                "cached executor-binding-authorization-decision artifact invalid",
            )
        if existing.get("data") != self._artifact_data(evaluated):
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionBoundaryFailure(
                "executor_binding_authorization_decision_validation",
                "executor_binding_authorization_decision_artifact",
                "cached executor-binding-authorization-decision artifact binds different identities",
            )
    ...
    def build_executor_binding_authorization_decision(
        ...
        self._save_state(state)
        if (
            self.failure_boundary_id == "final_executor_binding_authorization_decision_artifact"
            and not self._failure_fired
        ):
            self._failure_fired = True
            self._record_incident(
                "final_executor_binding_authorization_decision_artifact", state
            )
            self._write_metrics(state)
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionBoundaryFailure(
                "executor_binding_authorization_decision_artifact_assembly",
                "final_executor_binding_authorization_decision_artifact",
                self.failure_class,
            )
    ...
    def finalize(self, artifact: dict[str, Any]) -> None:
        if not artifact or artifact.get("status") != "locked":
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "final executor-binding-authorization-decision artifact is not locked"
            )
        if semantic_digest(artifact) != artifact.get("content_digest"):
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "final executor-binding-authorization-decision artifact digest invalid"
            )
        data = artifact.get("data") or {}
        self._assert_no_authority(data, "Iteration 24 artifact")
        for flag in (
            "real_executor_bound",
            "real_executor_invoked",
            "production_credentials_present",
        ...
        if classification == "executor_binding_authorization_decision_complete":
            if (
                data.get("executor_binding_authorization_review_classification")
                != "executor_binding_authorization_review_complete"
            ):
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                    "executor_binding_authorization_decision_complete requires complete Iteration 23 review"
                )
            if not data.get("separate_executor_binding_authorization_decision_id"):
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                    "executor_binding_authorization_decision_complete requires separate authorization-decision record"
                )
            ids = list(data.get("executor_binding_authorization_decision_evidence_ids") or [])
            digests = list(data.get("executor_binding_authorization_decision_evidence_digests") or [])
            if len(ids) != 10 or len(digests) != 10:
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                    "executor_binding_authorization_decision_complete requires ten receipts"
                )
            if len(ids) != len(set(ids)) or len(digests) != len(set(digests)):
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                    "executor-binding-authorization-decision evidence inventory contains duplicates"
                )
            loaded = []
            for position, (expected_id, expected_digest) in enumerate(
                ...
                if receipt is None:
                    raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                        f"executor-binding-authorization-decision evidence missing at position {position}"
                    )
                if (
                    ...
                    raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                        f"unsafe or corrupted executor-binding-authorization-decision evidence at position {position}"
                    )
            ...
            if digest(loaded) != data.get(
                ...
                raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                    "executor-binding-authorization-decision evidence set digest changed"
                )
        elif classification not in {"blocked", "invalid"}:
            raise IntegrationExecutionExecutorBindingAuthorizationDecisionError(
                "unsupported executor-binding-authorization-decision classification"
            )
