...
from .contracts import (
    ...
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_POLICY_VERSION,
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_SCHEMA_VERSION,
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_EVIDENCE_VERSION,
    ...
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_READINESS_RECORD_VERSION,
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_READINESS_SCHEMA_VERSION,
)
from .integration_execution_executor_binding_authorization_package import (
    ProductionIntegrationExecutionExecutorBindingAuthorizationPackage,
    IntegrationExecutionExecutorBindingAuthorizationPackageError,
)
from .store import CanonicalStore, ContractError, digest, semantic_digest


class IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(ContractError):
    pass


class IntegrationExecutionExecutorBindingAuthorizationPackageReadinessBoundaryFailure(
...
class ProductionIntegrationExecutionExecutorBindingAuthorizationPackageReadiness:
    """Deterministic synthetic-only Iteration 26 executor-binding authorization-package readiness gate."""

    ARTIFACT_TYPE = "production-integration-execution-executor-binding-authorization-package-readiness"
    SOURCE_ARTIFACT_TYPE = "production-integration-execution-executor-binding-authorization-package"
    ...
    POLICY_KEYS = {
        ...
        "classifications",
        "require_separate_authorization_package_readiness_record",
    ...
    MANIFEST_KEYS = {
        "schema_version",
        "executor_binding_authorization_package_readiness_manifest_version",
        "manifest_id",
        "synthetic_only",
        "production_action_authorized",
        "production_cutover_authorized",
        ...
        "rollback_execution_authorized",
        "real_integration_steps_enabled",
        "executor_binding_authorization_package_binding",
        "evidence",
        *MUTATION_FLAGS,
    }
    EVIDENCE_KEYS = {
    ...
    RECORD_KEYS = {
        ...
        "record_version",
        "record_kind",
        "authorization_package_readiness_record_id",
        "decision",
        "approved",
        "noop",
        "non_live",
        ...
        "executor_binding_authorization_decision_artifact_digest",
        "executor_binding_authorization_decision_id",
        "executor_binding_authorization_decision_policy_id",
        "executor_binding_authorization_decision_policy_digest",
        "executor_binding_authorization_decision_manifest_id",
        "executor_binding_authorization_decision_manifest_digest",
        "separate_executor_binding_authorization_decision_id",
        "separate_executor_binding_authorization_decision_digest",
        "executor_binding_authorization_decision_evidence_ids",
        "executor_binding_authorization_decision_evidence_digests",
        "executor_binding_authorization_decision_evidence_set_digest",
    ...
    def __init__(
        ...
        *,
        ...
        failure_class: str = "synthetic_integration_execution_executor_binding_authorization_package_readiness_boundary_failure",
    ):
        self.store = store
        ...
        self.failure_boundary_id = (
            failure_boundary_id.removeprefix("executor_binding_authorization_package_readiness:")
            if failure_boundary_id
            else None
        )
        self.failure_class = failure_class
        self._failure_fired = False
        self.state_path = self.store.run_dir / "executor-binding-authorization-package-readiness-state.json"
        self.metrics_path = self.store.run_dir / "executor-binding-authorization-package-readiness-metrics.json"
        self.incident_path = self.store.run_dir / "executor-binding-authorization-package-readiness-incident.json"
    ...
    def _read_json_fixture(self, name: str, *, optional: bool = False) -> dict[str, Any] | None:
        if self.mode == "production" or self.fixture_root is None:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "production executor-binding authorization-package readiness is intentionally unconfigured"
            )
        ...
        if not path.exists():
            if optional:
                return None
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                f"executor-binding-authorization-package-readiness fixture missing: {name}"
            )
    ...
    def _bound_upstream_identity(
        ...
        return {
            **deepcopy(semantic_identity),
            "executor_binding_authorization_package_artifact_digest": artifact["content_digest"],
            "executor_binding_authorization_package_id": data["executor_binding_authorization_package_id"],
            "executor_binding_authorization_package_classification": data["classification"],
            "executor_binding_authorization_package_reason_codes": deepcopy(
                data.get("classification_reason_codes") or []
            ),
            "executor_binding_authorization_package_policy_id": data.get(
                "executor_binding_authorization_package_policy_id"
            ),
            "executor_binding_authorization_package_policy_digest": data.get(
                "executor_binding_authorization_package_policy_digest"
            ),
            "executor_binding_authorization_package_manifest_id": data.get(
                "executor_binding_authorization_package_manifest_id"
            ),
            "executor_binding_authorization_package_manifest_digest": data.get(
                "executor_binding_authorization_package_manifest_digest"
            ),
            "separate_executor_binding_authorization_package_id": data.get(
                "separate_executor_binding_authorization_package_id"
            ),
            "separate_executor_binding_authorization_package_digest": data.get(
                "separate_executor_binding_authorization_package_digest"
            ),
            ...
            "executor_binding_authorization_package_evidence_ids": deepcopy(
                data.get("executor_binding_authorization_package_evidence_ids") or []
            ),
            "executor_binding_authorization_package_evidence_digests": deepcopy(
                data.get("executor_binding_authorization_package_evidence_digests") or []
            ),
            "executor_binding_authorization_package_evidence_set_digest": digest(validations),
            "canonical_chain_digest": data.get("canonical_chain_digest"),
            "iteration25_semantic_identity": semantic_identity,
            "iteration25_semantic_identity_digest": digest(semantic_identity),
        }

    def _context(self, run: dict[str, Any]) -> dict[str, Any]:
        if self.mode not in {"synthetic", "shadow"}:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError("synthetic/shadow only")
        prior = ProductionIntegrationExecutionExecutorBindingAuthorizationPackage(
        ...
        try:
            ...
            if (not evaluation or digest(evaluation) != state.get("evaluation_digest")
                ...
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                    "Iteration 25 durable decision identity is stale or corrupted")
            if (data.get("executor_binding_authorization_package_schema_version") != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_SCHEMA_VERSION
                    or data.get("executor_binding_authorization_package_policy_version") != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_POLICY_VERSION
                    or data.get("executor_binding_authorization_package_policy_id") != "production-integration-execution-executor-binding-authorization-package-v1"
                    or data.get("executor_binding_authorization_package_manifest_id") != "production-integration-execution-executor-binding-authorization-package-manifest-v1"):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError("unsupported Iteration 25 identity/version")
            validations = []
            for position, source in enumerate(prior_context["source_executor_binding_authorization_decision_evidence"], 1):
                if evaluation["classification"] != "executor_binding_authorization_package_complete":
                    break
                ...
                if record != prior._receipt_record(prior_context, evaluation, position, source):
                    raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                        f"Iteration 25 evidence changed/missing at position {position}")
                validations.append(record)
            expected = prior._artifact_data({**deepcopy(evaluation),
                "executor_binding_authorization_package_evidence_records": validations})
            if data != expected:
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError("Iteration 25 locked decision differs from exact durable evidence")
            prior.finalize(artifact)
        except IntegrationExecutionExecutorBindingAuthorizationPackageError as exc:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(str(exc)) from exc
        bound = self._bound_upstream_identity(artifact, data, validations)
        return {
            "executor_binding_authorization_package_artifact": artifact,
            "executor_binding_authorization_package_data": data,
            "source_executor_binding_authorization_package_evidence": validations,
    ...
    def _validate_policy_manifest(
        ...
        if set(policy) != self.POLICY_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "Iteration 26 policy contains unsupported fields"
            )
        if set(manifest) != self.MANIFEST_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "Iteration 26 manifest contains unsupported fields"
            )
        if (
            policy.get("schema_version")
            != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_READINESS_SCHEMA_VERSION
            or policy.get("executor_binding_authorization_package_readiness_policy_version")
            != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_READINESS_POLICY_VERSION
            or policy.get("policy_id")
            != "production-integration-execution-executor-binding-authorization-package-readiness-v1"
            ...
            != ["blocked", "executor_binding_authorization_package_readiness_complete", "invalid"]
            or policy.get("require_separate_authorization_package_readiness_record") is not True
            ...
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "unsupported or unsafe Iteration 26 executor-binding-authorization-package-readiness policy"
            )
        if (
            manifest.get("schema_version")
            != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_READINESS_SCHEMA_VERSION
            or manifest.get("executor_binding_authorization_package_readiness_manifest_version") != "1.0.0"
            or manifest.get("manifest_id")
            != "production-integration-execution-executor-binding-authorization-package-readiness-manifest-v1"
            or manifest.get("synthetic_only") is not True
        ):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "unsupported Iteration 26 executor-binding-authorization-package-readiness manifest"
            )
        self._assert_no_authority(manifest, "Iteration 26 manifest")
        binding = manifest.get("executor_binding_authorization_package_binding")
        if not isinstance(binding, dict):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError("invalid review binding")
        if binding and set(binding) != {
            "binding_mode", "executor_binding_authorization_package_artifact_digest",
            "executor_binding_authorization_package_id", "executor_binding_authorization_package_policy_id",
            "executor_binding_authorization_package_policy_digest", "executor_binding_authorization_package_manifest_id",
            "executor_binding_authorization_package_manifest_digest", "separate_executor_binding_authorization_package_id",
            "separate_executor_binding_authorization_package_digest", "synthetic_binding_plan_descriptor_id",
            "synthetic_binding_plan_descriptor_digest", "executor_binding_authorization_package_evidence_ids",
            "executor_binding_authorization_package_evidence_digests", "executor_binding_authorization_package_evidence_set_digest",
            "canonical_chain_digest", "iteration25_semantic_identity_digest", "bound_upstream_identity_digest"
        }:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError("unsupported review binding fields")
        evidence = manifest.get("evidence") or {}
        if set(evidence) != self.EVIDENCE_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "Iteration 26 manifest evidence contains unsupported fields"
            )
        ...
        if set(evidence.get("stop_abort_conditions") or []) != required:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "executor-binding-authorization-package-readiness stop/abort conditions incomplete"
            )
    ...
    def _record_binding(
        ...
        if record is None:
            return {
                "authorization_package_readiness_record_id": None,
                "authorization_package_readiness_record_digest": None,
            }, "EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_READINESS_RECORD_MISSING"
        if set(record) != self.RECORD_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "executor-binding-authorization-package-readiness record contains unsupported fields"
            )
        body = deepcopy(record)
        supplied = body.pop("authorization_package_readiness_record_id")
        if supplied != digest(body):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "executor-binding-authorization-package-readiness record semantic identity changed"
            )
        bound = context["bound_upstream_identity"]
        expected = {
            "schema_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_READINESS_SCHEMA_VERSION,
            "record_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_READINESS_RECORD_VERSION,
            "record_kind": "production-integration-execution-executor-binding-authorization-package-readiness-record",
            "decision": "complete_synthetic_executor_binding_authorization_package_readiness",
            "approved": True,
            "noop": True,
            "non_live": True,
            "executor_binding_authorization_package_evidence_ids": bound["executor_binding_authorization_package_evidence_ids"],
            "executor_binding_authorization_package_evidence_digests": bound["executor_binding_authorization_package_evidence_digests"],
            "scope": "execution_executor_binding_authorization_package_readiness_only",
            "synthetic_only": True,
            "executor_binding_authorization_package_artifact_digest": bound[
                "executor_binding_authorization_package_artifact_digest"
            ],
            "executor_binding_authorization_package_id": bound["executor_binding_authorization_package_id"],
            ...
            "executor_binding_authorization_decision_artifact_digest": bound["executor_binding_authorization_decision_artifact_digest"],
            "executor_binding_authorization_decision_id": bound["executor_binding_authorization_decision_id"],
            "executor_binding_authorization_decision_policy_id": bound["executor_binding_authorization_decision_policy_id"],
            "executor_binding_authorization_decision_policy_digest": bound["executor_binding_authorization_decision_policy_digest"],
            "executor_binding_authorization_decision_manifest_id": bound["executor_binding_authorization_decision_manifest_id"],
            "executor_binding_authorization_decision_manifest_digest": bound["executor_binding_authorization_decision_manifest_digest"],
            "separate_executor_binding_authorization_decision_id": bound["separate_executor_binding_authorization_decision_id"],
            "separate_executor_binding_authorization_decision_digest": bound["separate_executor_binding_authorization_decision_digest"],
            "executor_binding_authorization_decision_evidence_ids": bound["executor_binding_authorization_decision_evidence_ids"],
            "executor_binding_authorization_decision_evidence_digests": bound["executor_binding_authorization_decision_evidence_digests"],
            "executor_binding_authorization_decision_evidence_set_digest": bound["executor_binding_authorization_decision_evidence_set_digest"],
            ...
            "executor_binding_authorization_package_readiness_manifest_id": manifest["manifest_id"],
        ...
        for key, value in expected.items():
            if digest(record.get(key)) != digest(value):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                    f"executor-binding-authorization-package-readiness record binding changed: {key}"
                )
        return {
            "authorization_package_readiness_record_id": supplied,
            "authorization_package_readiness_record_digest": digest(record),
        }, None

    def _policy_manifest_record(
        self, context: dict[str, Any]
    ) -> tuple[dict[str, Any], dict[str, Any], dict[str, Any] | None]:
        policy = self._read_json_fixture("executor-binding-authorization-package-readiness-policy.json")
        manifest = self._read_json_fixture("executor-binding-authorization-package-readiness-manifest.json")
        record = self._read_json_fixture(
            "executor-binding-authorization-package-readiness-record.json", optional=True
        )
    ...
    def _evaluate(
        ...
        source = context["bound_upstream_identity"][
            "executor_binding_authorization_package_classification"
        ]
        reasons = context["bound_upstream_identity"][
            "executor_binding_authorization_package_reason_codes"
        ]
        bound = context["bound_upstream_identity"]
        ...
        if binding != expected_source_binding and not (binding == {} and source in {"blocked", "invalid"}):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "executor-binding-authorization-package-readiness manifest binds a different Iteration 25 identity"
            )
        if source == "invalid":
            return {
                "classification": "invalid",
                "classification_reason_codes": [
                    "ITERATION25_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_INVALID",
                    *reasons,
                ],
                "decision_binding": {
                    "authorization_package_readiness_record_id": None,
    ...
    def _input_identity(
        ...
        return {
            ...
            "executor_binding_authorization_package_id": bound["executor_binding_authorization_package_id"],
            "bound_upstream_identity_digest": context["bound_upstream_identity_digest"],
            "executor_binding_authorization_package_readiness_policy_digest": digest(policy),
            "executor_binding_authorization_package_readiness_manifest_digest": digest(manifest),
            "authorization_package_readiness_record_digest": digest(record) if record else None,
            "authorization_package_readiness_record_id": record.get("authorization_package_readiness_record_id") if record else None,
        }
    ...
    def _load_state(self, identity: dict[str, Any]) -> dict[str, Any]:
        ...
        if (
            ...
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "executor-binding-authorization-package-readiness durable state binds different inputs"
            )
        return state
    ...
    def _recover_incident_if_needed(self, state: dict[str, Any]) -> None:
        ...
        if incident and incident.get("result") == "pending":
            if incident.get("input_identity") != state.get("input_identity"):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                    "executor-binding-authorization-package-readiness incident binds different inputs"
                )
            incident["result"] = "recovered"
            self.store._atomic_write(self.incident_path, incident)

    def _receipt_path(self, position: int) -> Path:
        return self.store.run_dir / f"executor-binding-authorization-package-readiness-evidence-{position:02d}.json"
    ...
    def _receipt_record(
        ...
        body = {
            "schema_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_READINESS_SCHEMA_VERSION,
            "receipt_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_READINESS_EVIDENCE_VERSION,
            "executor_binding_authorization_package_id": bound["executor_binding_authorization_package_id"],
            "executor_binding_authorization_package_artifact_digest": bound[
                "executor_binding_authorization_package_artifact_digest"
            ],
            "executor_binding_authorization_package_readiness_record_id": evaluated[
                "decision_binding"
            ]["authorization_package_readiness_record_id"],
            "synthetic_binding_plan_descriptor_id": bound[
                "synthetic_binding_plan_descriptor_id"
            ...
            "position": position,
            "source_executor_binding_authorization_package_evidence_id": source["receipt_id"],
            "source_executor_binding_authorization_package_evidence_digest": digest(source),
            "noop_verified": True,
    ...
    def _ensure_receipts(
        ...
        if evaluated["classification"] != "executor_binding_authorization_package_readiness_complete":
            return []
        sources = context["source_executor_binding_authorization_package_evidence"]
        if len(sources) != 10:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
        ...
        for position, source in enumerate(sources, start=1):
            ...
            if existing is not None:
                if existing != expected:
                    raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                        f"cached executor-binding-authorization-package-readiness evidence changed at position {position}"
                    )
    ...
    def prepare(self, run: dict[str, Any]) -> dict[str, Any]:
        ...
        if state.get("evaluation") is None:
            ...
            if self.failure_boundary_id == "evaluation" and not self._failure_fired:
                ...
                self._write_metrics(state)
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessBoundaryFailure(
                    "executor_binding_authorization_package_readiness_evaluation",
                    "evaluation",
                    self.failure_class,
                )
            ...
            state["evaluation"] = {
                **outcome,
                ...
                "executor_binding_authorization_package_readiness_policy_id": policy["policy_id"],
                "executor_binding_authorization_package_readiness_policy_version": policy[
                    "executor_binding_authorization_package_readiness_policy_version"
                ],
                "executor_binding_authorization_package_readiness_manifest_id": manifest["manifest_id"],
            ...
            if digest(state["evaluation"]) != state.get("evaluation_digest"):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError("cached decision evaluation corrupted")
        ...
        evaluated["executor_binding_authorization_package_readiness_evidence_records"] = receipts
    ...
    def _artifact_data(self, evaluated: dict[str, Any]) -> dict[str, Any]:
        ...
        receipts = evaluated["executor_binding_authorization_package_readiness_evidence_records"]
        evidence = evaluated["evidence"]
        if evaluated["classification"] == "executor_binding_authorization_package_readiness_complete":
            if len(receipts) != 10:
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                    "executor_binding_authorization_package_readiness_complete requires ten no-op receipts"
                )
            if len({x["receipt_id"] for x in receipts}) != 10:
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                    "executor-binding-authorization-package-readiness evidence identities must be unique"
                )
        elif receipts:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
        ...
        identity = {
            ...
            "executor_binding_authorization_package_readiness_policy_version": evaluated[
                "executor_binding_authorization_package_readiness_policy_version"
            ],
            "executor_binding_authorization_package_readiness_policy_id": evaluated[
                "executor_binding_authorization_package_readiness_policy_id"
            ],
            "executor_binding_authorization_package_readiness_policy_digest": evaluated[
                "input_identity"
            ]["executor_binding_authorization_package_readiness_policy_digest"],
            "executor_binding_authorization_package_readiness_manifest_id": evaluated[
                "executor_binding_authorization_package_readiness_manifest_id"
            ],
            "executor_binding_authorization_package_readiness_manifest_digest": evaluated[
                "input_identity"
            ]["executor_binding_authorization_package_readiness_manifest_digest"],
            "separate_executor_binding_authorization_package_readiness_id": decision_binding[
                "authorization_package_readiness_record_id"
            ],
            "separate_executor_binding_authorization_package_readiness_digest": decision_binding[
                "authorization_package_readiness_record_digest"
            ],
            **deepcopy(evaluated["bound_upstream_identity"]),
            ...
            "executor_binding_authorization_package_readiness_evidence_set_digest": digest(receipts),
        ...
        return {
            **identity,
            "executor_binding_authorization_package_readiness_id": digest(identity),
            "real_integration_steps_enabled": 0,
            "real_integration_steps_executed": 0,
            "final_state": "Complete",
            "final_status": "complete_locked",
            "completion_scope": (
                "synthetic_shadow_execution_executor_binding_authorization_package_readiness_only"
            ),
            "synthetic_only": True,
            "production_action_authorized": False,
            "production_cutover_authorized": False,
    ...
    def validate_existing(
        ...
        if (
            ...
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessBoundaryFailure(
                "executor_binding_authorization_package_readiness_validation",
                "executor_binding_authorization_package_readiness_artifact",
                "cached executor-binding-authorization-package-readiness artifact invalid",
            )
        if existing.get("data") != self._artifact_data(evaluated):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessBoundaryFailure(
                "executor_binding_authorization_package_readiness_validation",
                "executor_binding_authorization_package_readiness_artifact",
                "cached executor-binding-authorization-package-readiness artifact binds different identities",
            )
    ...
    def build_executor_binding_authorization_package_readiness(
        ...
        self._save_state(state)
        if (
            self.failure_boundary_id == "final_executor_binding_authorization_package_readiness_artifact"
            and not self._failure_fired
        ):
            self._failure_fired = True
            self._record_incident(
                "final_executor_binding_authorization_package_readiness_artifact", state
            )
            self._write_metrics(state)
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessBoundaryFailure(
                "executor_binding_authorization_package_readiness_artifact_assembly",
    ...
    def finalize(self, artifact: dict[str, Any]) -> None:
        if not artifact or artifact.get("status") != "locked":
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "final executor-binding-authorization-package-readiness artifact is not locked"
            )
        if semantic_digest(artifact) != artifact.get("content_digest"):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "final executor-binding-authorization-package-readiness artifact digest invalid"
            )
        data = artifact.get("data") or {}
        self._assert_no_authority(data, "Iteration 26 artifact")
        for flag in (
            "real_executor_bound",
            "real_executor_invoked",
            "production_credentials_present",
            ...
            if data.get(flag) is not False:
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                    f"executor-binding authorization package cannot perform {flag}"
                )
        classification = data.get("classification")
        if classification == "executor_binding_authorization_package_readiness_complete":
            if (
                data.get("executor_binding_authorization_package_classification")
                != "executor_binding_authorization_package_complete"
            ):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                    "executor_binding_authorization_package_readiness_complete requires complete Iteration 25 decision"
                )
            if not data.get("separate_executor_binding_authorization_package_readiness_id"):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                    "executor_binding_authorization_package_readiness_complete requires separate authorization-decision record"
                )
            ids = list(data.get("executor_binding_authorization_package_readiness_evidence_ids") or [])
            digests = list(data.get("executor_binding_authorization_package_readiness_evidence_digests") or [])
            if len(ids) != 10 or len(digests) != 10:
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                    "executor_binding_authorization_package_readiness_complete requires ten receipts"
                )
            if len(ids) != len(set(ids)) or len(digests) != len(set(digests)):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                    "executor-binding-authorization-package-readiness evidence inventory contains duplicates"
                )
            loaded = []
            for position, (expected_id, expected_digest) in enumerate(
                ...
                if receipt is None:
                    raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                        f"executor-binding-authorization-package-readiness evidence missing at position {position}"
                    )
                if (
                    ...
                    raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                        f"unsafe or corrupted executor-binding-authorization-package-readiness evidence at position {position}"
                    )
            ...
            if digest(loaded) != data.get(
                ...
                raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                    "executor-binding-authorization-package-readiness evidence set digest changed"
                )
        elif classification not in {"blocked", "invalid"}:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageReadinessError(
                "unsupported executor-binding-authorization-package-readiness classification"
            )
