...
from .contracts import (
    ...
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_RECORD_VERSION,
    EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_SCHEMA_VERSION,
)
from .integration_execution_executor_binding_authorization_decision import (
...
class IntegrationExecutionExecutorBindingAuthorizationPackageError(ContractError):
    pass


class IntegrationExecutionExecutorBindingAuthorizationPackageBoundaryFailure(
...
class ProductionIntegrationExecutionExecutorBindingAuthorizationPackage:
    """Deterministic synthetic-only Iteration 25 executor-binding authorization package gate."""

    ARTIFACT_TYPE = "production-integration-execution-executor-binding-authorization-package"
    SOURCE_ARTIFACT_TYPE = "production-integration-execution-executor-binding-authorization-decision"
    ...
    POLICY_KEYS = {
        "schema_version",
        "executor_binding_authorization_package_policy_version",
        "policy_id",
        "synthetic_only",
    ...
    MANIFEST_KEYS = {
        "schema_version",
        "executor_binding_authorization_package_manifest_version",
        "manifest_id",
        "synthetic_only",
        "production_action_authorized",
        "production_cutover_authorized",
        ...
        "rollback_execution_authorized",
        "real_integration_steps_enabled",
        "executor_binding_authorization_decision_binding",
        "evidence",
        *MUTATION_FLAGS,
    }
    EVIDENCE_KEYS = {
    ...
    def __init__(
        ...
        *,
        ...
        failure_class: str = "synthetic_integration_execution_executor_binding_authorization_package_boundary_failure",
    ):
        self.store = store
        ...
        self.failure_boundary_id = (
            failure_boundary_id.removeprefix("executor_binding_authorization_package:")
            if failure_boundary_id
            else None
        )
        self.failure_class = failure_class
        self._failure_fired = False
        self.state_path = self.store.run_dir / "executor-binding-authorization-package-state.json"
        self.metrics_path = self.store.run_dir / "executor-binding-authorization-package-metrics.json"
        self.incident_path = self.store.run_dir / "executor-binding-authorization-package-incident.json"
    ...
    def _read_json_fixture(self, name: str, *, optional: bool = False) -> dict[str, Any] | None:
        ...
        if not path.exists():
            if optional:
                return None
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                f"executor-binding-authorization-package fixture missing: {name}"
            )
    ...
    def _bound_upstream_identity(
        ...
        return {
            **deepcopy(semantic_identity),
            "executor_binding_authorization_decision_artifact_digest": artifact["content_digest"],
            "executor_binding_authorization_decision_id": data["executor_binding_authorization_decision_id"],
            "executor_binding_authorization_decision_classification": data["classification"],
            "executor_binding_authorization_decision_reason_codes": deepcopy(
                data.get("classification_reason_codes") or []
            ),
            "executor_binding_authorization_decision_policy_id": data.get(
                "executor_binding_authorization_decision_policy_id"
            ),
            "executor_binding_authorization_decision_policy_digest": data.get(
                "executor_binding_authorization_decision_policy_digest"
            ),
            "executor_binding_authorization_decision_manifest_id": data.get(
                "executor_binding_authorization_decision_manifest_id"
            ),
            "executor_binding_authorization_decision_manifest_digest": data.get(
                "executor_binding_authorization_decision_manifest_digest"
            ),
            "separate_executor_binding_authorization_decision_id": data.get(
                "separate_executor_binding_authorization_decision_id"
            ),
            "separate_executor_binding_authorization_decision_digest": data.get(
                "separate_executor_binding_authorization_decision_digest"
            ),
            ...
            "executor_binding_authorization_decision_evidence_ids": deepcopy(
                data.get("executor_binding_authorization_decision_evidence_ids") or []
            ),
            "executor_binding_authorization_decision_evidence_digests": deepcopy(
                data.get("executor_binding_authorization_decision_evidence_digests") or []
            ),
            "executor_binding_authorization_decision_evidence_set_digest": digest(validations),
            "canonical_chain_digest": data.get("canonical_chain_digest"),
            "iteration24_semantic_identity": semantic_identity,
            "iteration24_semantic_identity_digest": digest(semantic_identity),
        }

    def _context(self, run: dict[str, Any]) -> dict[str, Any]:
        if self.mode not in {"synthetic", "shadow"}:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError("synthetic/shadow only")
        prior = ProductionIntegrationExecutionExecutorBindingAuthorizationDecision(
        ...
        try:
            ...
            if (data.get("executor_binding_authorization_decision_schema_version") != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_DECISION_SCHEMA_VERSION
                    ...
                    or data.get("executor_binding_authorization_decision_manifest_id") != "production-integration-execution-executor-binding-authorization-decision-manifest-v1"):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageError("unsupported Iteration 24 identity/version")
            validations = []
            for position, source in enumerate(prior_context["source_executor_binding_authorization_review_evidence"], 1):
                if evaluation["classification"] != "executor_binding_authorization_decision_complete":
                    break
                ...
                if record != prior._receipt_record(prior_context, evaluation, position, source):
                    raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                        f"Iteration 24 evidence changed/missing at position {position}")
        ...
        return {
            "executor_binding_authorization_decision_artifact": artifact,
            "executor_binding_authorization_decision_data": data,
            "source_executor_binding_authorization_decision_evidence": validations,
    ...
    def _validate_policy_manifest(
        ...
        if set(policy) != self.POLICY_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "Iteration 25 policy contains unsupported fields"
            )
        if set(manifest) != self.MANIFEST_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "Iteration 25 manifest contains unsupported fields"
            )
        if (
            policy.get("schema_version")
            != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_SCHEMA_VERSION
            or policy.get("executor_binding_authorization_package_policy_version")
            != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_POLICY_VERSION
            or policy.get("policy_id")
            != "production-integration-execution-executor-binding-authorization-package-v1"
            ...
            != ["blocked", "executor_binding_authorization_package_complete", "invalid"]
            ...
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "unsupported or unsafe Iteration 25 executor-binding-authorization-package policy"
            )
        if (
            manifest.get("schema_version")
            != EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_SCHEMA_VERSION
            or manifest.get("executor_binding_authorization_package_manifest_version") != "1.0.0"
            or manifest.get("manifest_id")
            != "production-integration-execution-executor-binding-authorization-package-manifest-v1"
            or manifest.get("synthetic_only") is not True
        ):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "unsupported Iteration 25 executor-binding-authorization-package manifest"
            )
        self._assert_no_authority(manifest, "Iteration 25 manifest")
        binding = manifest.get("executor_binding_authorization_decision_binding")
        if not isinstance(binding, dict):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError("invalid review binding")
        if binding and set(binding) != {
            "binding_mode", "executor_binding_authorization_decision_artifact_digest",
            "executor_binding_authorization_decision_id", "executor_binding_authorization_decision_policy_id",
            "executor_binding_authorization_decision_policy_digest", "executor_binding_authorization_decision_manifest_id",
            "executor_binding_authorization_decision_manifest_digest", "separate_executor_binding_authorization_decision_id",
            "separate_executor_binding_authorization_decision_digest", "synthetic_binding_plan_descriptor_id",
            "synthetic_binding_plan_descriptor_digest", "executor_binding_authorization_decision_evidence_ids",
            "executor_binding_authorization_decision_evidence_digests", "executor_binding_authorization_decision_evidence_set_digest",
            "canonical_chain_digest", "iteration24_semantic_identity_digest", "bound_upstream_identity_digest"
        }:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError("unsupported review binding fields")
        evidence = manifest.get("evidence") or {}
        if set(evidence) != self.EVIDENCE_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "Iteration 25 manifest evidence contains unsupported fields"
            )
        ...
        if set(evidence.get("stop_abort_conditions") or []) != required:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "executor-binding-authorization-package stop/abort conditions incomplete"
            )
    ...
    def _record_binding(
        ...
        if record is None:
            ...
            }, "EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_RECORD_MISSING"
        if set(record) != self.RECORD_KEYS:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "executor-binding-authorization-package record contains unsupported fields"
            )
        body = deepcopy(record)
        supplied = body.pop("authorization_package_record_id")
        if supplied != digest(body):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "executor-binding-authorization-package record semantic identity changed"
            )
        bound = context["bound_upstream_identity"]
        expected = {
            "schema_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_SCHEMA_VERSION,
            "record_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_RECORD_VERSION,
            "record_kind": "production-integration-execution-executor-binding-authorization-package-record",
            "decision": "complete_synthetic_executor_binding_authorization_package",
            "approved": True,
            "noop": True,
            "non_live": True,
            ...
            "scope": "execution_executor_binding_authorization_package_only",
            "synthetic_only": True,
            "executor_binding_authorization_decision_artifact_digest": bound[
                "executor_binding_authorization_decision_artifact_digest"
            ],
            "executor_binding_authorization_decision_id": bound["executor_binding_authorization_decision_id"],
            "executor_binding_authorization_decision_policy_id": bound[
                "executor_binding_authorization_decision_policy_id"
            ],
            "executor_binding_authorization_decision_policy_digest": bound[
                "executor_binding_authorization_decision_policy_digest"
            ],
            "executor_binding_authorization_decision_manifest_id": bound[
                "executor_binding_authorization_decision_manifest_id"
            ],
            "executor_binding_authorization_decision_manifest_digest": bound[
                "executor_binding_authorization_decision_manifest_digest"
            ],
            "separate_executor_binding_authorization_decision_id": bound[
                "separate_executor_binding_authorization_decision_id"
            ],
            "separate_executor_binding_authorization_decision_digest": bound[
                "separate_executor_binding_authorization_decision_digest"
            ],
            ...
            "executor_binding_authorization_decision_evidence_set_digest": bound[
                "executor_binding_authorization_decision_evidence_set_digest"
            ],
            "canonical_chain_digest": bound["canonical_chain_digest"],
            "bound_upstream_identity_digest": context["bound_upstream_identity_digest"],
            "executor_binding_authorization_package_manifest_id": manifest["manifest_id"],
        ...
        for key, value in expected.items():
            if digest(record.get(key)) != digest(value):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                    f"executor-binding-authorization-package record binding changed: {key}"
                )
        return {
    ...
    def _policy_manifest_record(
        ...
        policy = self._read_json_fixture("executor-binding-authorization-package-policy.json")
        manifest = self._read_json_fixture("executor-binding-authorization-package-manifest.json")
        record = self._read_json_fixture(
            "executor-binding-authorization-package-record.json", optional=True
        )
    ...
    def _evaluate(
        ...
        source = context["bound_upstream_identity"][
            "executor_binding_authorization_decision_classification"
        ]
        reasons = context["bound_upstream_identity"][
            "executor_binding_authorization_decision_reason_codes"
        ]
        bound = context["bound_upstream_identity"]
        expected_source_binding = {
            "binding_mode": "exact_locked_executor_binding_authorization_decision_artifact",
            "executor_binding_authorization_decision_artifact_digest": bound[
                "executor_binding_authorization_decision_artifact_digest"
            ],
            "executor_binding_authorization_decision_id": bound["executor_binding_authorization_decision_id"],
            ...
            "executor_binding_authorization_decision_evidence_ids": bound[
                "executor_binding_authorization_decision_evidence_ids"
            ],
            "executor_binding_authorization_decision_evidence_digests": bound[
                "executor_binding_authorization_decision_evidence_digests"
            ],
            "executor_binding_authorization_decision_evidence_set_digest": bound[
                "executor_binding_authorization_decision_evidence_set_digest"
        ...
        if binding != expected_source_binding and not (binding == {} and source in {"blocked", "invalid"}):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "executor-binding-authorization-package manifest binds a different Iteration 24 identity"
            )
        if source == "invalid":
            return {
        ...
        return {
            "classification": "executor_binding_authorization_package_complete",
            "classification_reason_codes": [
    ...
    def _input_identity(
        ...
        return {
            ...
            "executor_binding_authorization_decision_id": bound["executor_binding_authorization_decision_id"],
            "bound_upstream_identity_digest": context["bound_upstream_identity_digest"],
            "executor_binding_authorization_package_policy_digest": digest(policy),
            "executor_binding_authorization_package_manifest_digest": digest(manifest),
    ...
    def _load_state(self, identity: dict[str, Any]) -> dict[str, Any]:
        ...
        if (
            ...
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "executor-binding-authorization-package durable state binds different inputs"
            )
        return state
    ...
    def _recover_incident_if_needed(self, state: dict[str, Any]) -> None:
        ...
        if incident and incident.get("result") == "pending":
            if incident.get("input_identity") != state.get("input_identity"):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                    "executor-binding-authorization-package incident binds different inputs"
                )
            incident["result"] = "recovered"
            self.store._atomic_write(self.incident_path, incident)

    def _receipt_path(self, position: int) -> Path:
        return self.store.run_dir / f"executor-binding-authorization-package-evidence-{position:02d}.json"
    ...
    def _receipt_record(
        ...
        body = {
            "schema_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_SCHEMA_VERSION,
            "receipt_version": EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_EVIDENCE_VERSION,
            "executor_binding_authorization_decision_id": bound["executor_binding_authorization_decision_id"],
            "executor_binding_authorization_decision_artifact_digest": bound[
                "executor_binding_authorization_decision_artifact_digest"
            ],
            "executor_binding_authorization_package_record_id": evaluated[
                "decision_binding"
            ]["authorization_package_record_id"],
            "synthetic_binding_plan_descriptor_id": bound[
                "synthetic_binding_plan_descriptor_id"
            ...
            "position": position,
            "source_executor_binding_authorization_decision_evidence_id": source["receipt_id"],
            "source_executor_binding_authorization_decision_evidence_digest": digest(source),
            "noop_verified": True,
    ...
    def _ensure_receipts(
        ...
        if evaluated["classification"] != "executor_binding_authorization_package_complete":
            return []
        sources = context["source_executor_binding_authorization_decision_evidence"]
        if len(sources) != 10:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
        ...
        for position, source in enumerate(sources, start=1):
            ...
            if existing is not None:
                if existing != expected:
                    raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                        f"cached executor-binding-authorization-package evidence changed at position {position}"
                    )
            ...
            if self.failure_boundary_id == boundary and not self._failure_fired:
                ...
                raise IntegrationExecutionExecutorBindingAuthorizationPackageBoundaryFailure(
                    "executor_binding_authorization_package_evidence",
                    boundary,
                    self.failure_class,
                )
    ...
    def prepare(self, run: dict[str, Any]) -> dict[str, Any]:
        ...
        if state.get("evaluation") is None:
            ...
            if self.failure_boundary_id == "evaluation" and not self._failure_fired:
                ...
                self._write_metrics(state)
                raise IntegrationExecutionExecutorBindingAuthorizationPackageBoundaryFailure(
                    "executor_binding_authorization_package_evaluation",
                    "evaluation",
                    self.failure_class,
                )
            ...
            state["evaluation"] = {
                **outcome,
                ...
                "executor_binding_authorization_package_policy_id": policy["policy_id"],
                "executor_binding_authorization_package_policy_version": policy[
                    "executor_binding_authorization_package_policy_version"
                ],
                "executor_binding_authorization_package_manifest_id": manifest["manifest_id"],
            ...
            if digest(state["evaluation"]) != state.get("evaluation_digest"):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageError("cached decision evaluation corrupted")
        ...
        evaluated["executor_binding_authorization_package_evidence_records"] = receipts
    ...
    def _artifact_data(self, evaluated: dict[str, Any]) -> dict[str, Any]:
        ...
        receipts = evaluated["executor_binding_authorization_package_evidence_records"]
        evidence = evaluated["evidence"]
        if evaluated["classification"] == "executor_binding_authorization_package_complete":
            if len(receipts) != 10:
                raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                    "executor_binding_authorization_package_complete requires ten no-op receipts"
                )
            if len({x["receipt_id"] for x in receipts}) != 10:
                raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                    "executor-binding-authorization-package evidence identities must be unique"
                )
        elif receipts:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
        ...
        identity = {
            "executor_binding_authorization_package_schema_version": (
                EXECUTION_EXECUTOR_BINDING_AUTHORIZATION_PACKAGE_SCHEMA_VERSION
            ),
            "executor_binding_authorization_package_policy_version": evaluated[
                "executor_binding_authorization_package_policy_version"
            ],
            "executor_binding_authorization_package_policy_id": evaluated[
                "executor_binding_authorization_package_policy_id"
            ],
            "executor_binding_authorization_package_policy_digest": evaluated[
                "input_identity"
            ]["executor_binding_authorization_package_policy_digest"],
            "executor_binding_authorization_package_manifest_id": evaluated[
                "executor_binding_authorization_package_manifest_id"
            ],
            "executor_binding_authorization_package_manifest_digest": evaluated[
                "input_identity"
            ]["executor_binding_authorization_package_manifest_digest"],
            "separate_executor_binding_authorization_package_id": decision_binding[
                "authorization_package_record_id"
            ],
            "separate_executor_binding_authorization_package_digest": decision_binding[
            ...
            **deepcopy(evaluated["bound_upstream_identity"]),
            ...
            "executor_binding_authorization_package_evidence_set_digest": digest(receipts),
        ...
        return {
            **identity,
            "executor_binding_authorization_package_id": digest(identity),
            "real_integration_steps_enabled": 0,
            "real_integration_steps_executed": 0,
            "final_state": "Complete",
            "final_status": "complete_locked",
            "completion_scope": (
                "synthetic_shadow_execution_executor_binding_authorization_package_only"
            ),
            "synthetic_only": True,
            "production_action_authorized": False,
            "production_cutover_authorized": False,
    ...
    def validate_existing(
        ...
        if (
            ...
            raise IntegrationExecutionExecutorBindingAuthorizationPackageBoundaryFailure(
                "executor_binding_authorization_package_validation",
                "executor_binding_authorization_package_artifact",
                "cached executor-binding-authorization-package artifact invalid",
            )
        if existing.get("data") != self._artifact_data(evaluated):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageBoundaryFailure(
                "executor_binding_authorization_package_validation",
                "executor_binding_authorization_package_artifact",
                "cached executor-binding-authorization-package artifact binds different identities",
            )
    ...
    def build_executor_binding_authorization_package(
        ...
        self._save_state(state)
        if (
            self.failure_boundary_id == "final_executor_binding_authorization_package_artifact"
            and not self._failure_fired
        ):
            self._failure_fired = True
            self._record_incident(
                "final_executor_binding_authorization_package_artifact", state
            )
            self._write_metrics(state)
            raise IntegrationExecutionExecutorBindingAuthorizationPackageBoundaryFailure(
                "executor_binding_authorization_package_artifact_assembly",
                "final_executor_binding_authorization_package_artifact",
                self.failure_class,
            )
    ...
    def finalize(self, artifact: dict[str, Any]) -> None:
        if not artifact or artifact.get("status") != "locked":
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "final executor-binding-authorization-package artifact is not locked"
            )
        if semantic_digest(artifact) != artifact.get("content_digest"):
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "final executor-binding-authorization-package artifact digest invalid"
            )
        data = artifact.get("data") or {}
        self._assert_no_authority(data, "Iteration 25 artifact")
        for flag in (
            "real_executor_bound",
            "real_executor_invoked",
            "production_credentials_present",
        ...
        if classification == "executor_binding_authorization_package_complete":
            if (
                data.get("executor_binding_authorization_decision_classification")
                != "executor_binding_authorization_decision_complete"
            ):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
            ...
            if not data.get("separate_executor_binding_authorization_package_id"):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                    "executor_binding_authorization_package_complete requires separate authorization-decision record"
                )
            ids = list(data.get("executor_binding_authorization_package_evidence_ids") or [])
            digests = list(data.get("executor_binding_authorization_package_evidence_digests") or [])
            if len(ids) != 10 or len(digests) != 10:
                raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                    "executor_binding_authorization_package_complete requires ten receipts"
                )
            if len(ids) != len(set(ids)) or len(digests) != len(set(digests)):
                raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                    "executor-binding-authorization-package evidence inventory contains duplicates"
                )
            loaded = []
            for position, (expected_id, expected_digest) in enumerate(
                ...
                if receipt is None:
                    raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                        f"executor-binding-authorization-package evidence missing at position {position}"
                    )
                if (
                    ...
                    raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                        f"unsafe or corrupted executor-binding-authorization-package evidence at position {position}"
                    )
            ...
            if digest(loaded) != data.get(
                ...
                raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                    "executor-binding-authorization-package evidence set digest changed"
                )
        elif classification not in {"blocked", "invalid"}:
            raise IntegrationExecutionExecutorBindingAuthorizationPackageError(
                "unsupported executor-binding-authorization-package classification"
            )
